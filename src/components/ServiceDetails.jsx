      ...
      <div className="bg-white max-w-lg w-full border border-[#E5E0D8] overflow-hidden" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <span className="text-xs text-[#B0A89A] uppercase tracking-wider">{t.serviceDetails.price}</span>
              <p className="text-2xl font-normal text-[#2E2E2E] mt-1">{t.services.from} {service.price}</p>
            </div>
            <button
