    ...
    <div className="min-h-screen bg-[#F5F2ED] flex items-center justify-center p-4 relative">
      ...
      <div className="bg-white border border-[#E5E0D8] p-10 max-w-sm w-full">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-normal text-[#2E2E2E] mb-2">Admin Panel</h1>
          <p className="text-sm text-[#B0A89A]">Mövenpick Siam Pattaya</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm text-[#6B6B6B] mb-2">Пароль</label>
            <input
              type="password"
              value={password}
